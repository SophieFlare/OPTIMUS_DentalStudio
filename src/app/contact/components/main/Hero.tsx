  ...
  return (
    <div className="relative flex flex-col  h-screen w-screen " id="contact hero">
      ...
      <video
        ...
        style={{
          filter:
            "hue-rotate(260deg) saturate(110%) brightness(0.95) contrast(115%)", 
        }}
      >
       {/*"hue-rotate(240deg) saturate(160%) brightness(0.9) contrast(120%)",*/}  
      ...
      {/* Glow Orb 
      <div className="absolute h-64 w-64 md:h-96 md:w-96 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[2] bg-[radial-gradient(50%_50%_at_30%_30%,white,rgb(148,222,255)_40%,rgb(0,115,110))] rounded-full shadow-[0_0_60px_rgba(120,255,255,0.5),0_0_120px_rgba(0,255,200,0.2)] opacity-60" />
      */}
       {/* Hero Content should be ABOVE everything */}
