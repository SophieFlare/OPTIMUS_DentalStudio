        ...
        >
          ...
          <div className="hidden md:block">
            <nav className="flex gap-8 text-sm">
              ...
              <Link href="/reviews" className="text-white/70 hover:text-[#8af4e8] transition">Reviews</Link>
              <Link href="/shop" className="text-white/70 hover:text-[#8af4e8] transition">Shop</Link>
